...
def upgrade() -> None:
    ...
    op.create_table(
        "currency",
        sa.Column(
            "currencyId", sa.Integer(), sa.Identity(always=False), nullable=False
        ),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "ix_item_modifierId_createdHoursSinceLaunch_itemId", table_name="item_modifier"
    )
    op.drop_table("item_modifier")
    op.drop_index(
        "ix_item_name_itemBaseTypeId_createdHoursSinceLaunch_league", table_name="item"
    )
