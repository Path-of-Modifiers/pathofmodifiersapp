...
modifier_df = pd.DataFrame(
    columns=["minRoll", "maxRoll", "textRolls", "position", "effect", "regex", "static", "filename"]
)
...
# grouped_dynamic_modifier_df["effect"] = grouped_dynamic_modifier_df["effect"].str.replace("+|-", r"(\+|\-)", regex=True)
...
# quit()
# grouped_dynamic_modifier_df["effect"] = grouped_dynamic_modifier_df["effect"].str.replace("+", r"\+")
# grouped_dynamic_modifier_df["effect"] = grouped_dynamic_modifier_df["effect"].str.replace("-", r"\-")
...
grouped_dynamic_modifier_df["regex"] = grouped_dynamic_modifier_df.apply(func, axis=1)
grouped_dynamic_modifier_df["regex"] = grouped_dynamic_modifier_df["regex"].str.replace("increased|reduced", r"(increased|reduced)", regex=True)
...
dynamic_modifier_df.drop(columns=["position_drop", "minRoll_drop", "textRolls_drop", "regex_drop", "rolls"], inplace=True)
