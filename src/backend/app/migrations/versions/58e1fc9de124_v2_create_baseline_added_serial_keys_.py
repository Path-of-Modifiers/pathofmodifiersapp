...
def upgrade() -> None:
    ...
    op.execute(schema.CreateSequence(schema.Sequence('modifier_id_seq', start=1, increment=1, minvalue=1, cycle=False, cache=1, schema=None)))
    op.execute(schema.CreateSequence(schema.Sequence('item_id_seq', start=1, increment=1, minvalue=1, cycle=False, cache=1, schema=None)))
    op.execute(schema.CreateSequence(schema.Sequence('currency_id_seq', start=1, increment=1, minvalue=1, cycle=False, cache=1, schema=None)))
    ...
    sa.ForeignKeyConstraint(['itemId', 'gameItemId'], ['item.itemId', 'item.gameItemId'], ondelete='CASCADE'),
