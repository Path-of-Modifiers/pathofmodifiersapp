...
const useCheckUsernameExists = () => {
    const [checkUsernameExistsErrorMessage, setErrorMessage] = useState<string>("");
    const [usernameExists, setUsernameExists] = useState<boolean | null>(null);
    const queryClient = useQueryClient();

    const checkUsernameExistsMutation = useMutation({
        mutationFn: (username: string) => // Accept username as a parameter
    ...
    return { usernameExists, checkUsernameExistsErrorMessage, checkUsernameExistsMutation };
};
